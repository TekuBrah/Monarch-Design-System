export const gradients = {
  'subtle': {
    ...
    mappedValue: 'linear-gradient(0deg, var(--mapped-surface-page) 0%, transparent 100%)',
  ...
  'default': {
    ...
    mappedValue: 'linear-gradient(0deg, var(--mapped-surface-page) 10%, color-mix(in srgb, var(--mapped-surface-page) 50%, transparent) 100%)',
